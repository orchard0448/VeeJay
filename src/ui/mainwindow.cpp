...
void MainWindow::midiSignal(double value)
{
    emit pitchBend(value);
}

AbstractFunction* MainWindow::GetMidiControl(void)
{
    printf("Oh Hi: %f\n", static_cast<FunctionMidi*>(midiControl)->midiVal());
    //printf("Yussss: %f\n", midiControl->)
    return midiControl;
}
