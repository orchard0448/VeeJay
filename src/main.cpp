...
int main(int argc, char *argv[])
{
    ...
    QString  path_krug        = QString(dir_image + "krug.jpg");
    ...
    // pull midi control
    AbstractFunction *midi    = w.GetMidiControl();
    ...
    WarpImage krug(path_krug, imsize);

    krug.set_vert_bord1(sin1);
    krug.set_vert_bord2(midi);
    krug.set_horz_bord1(midi);
    krug.set_horz_bord2(sin2);
    ...
    mixer.add_channel(krug.get_warped_pixmap(), QPainter::CompositionMode_SourceAtop , new FunctionScalar(1) );

    ///mixer.add_channel(static_stars.get_scaled_pixmap(), QPainter::CompositionMode_SourceAtop , new FunctionScalar(0.5) );
